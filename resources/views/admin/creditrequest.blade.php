...
<head>
    ...
    <title>Requested Credit By Buyer</title>
...
<body style="width: 100%;height: 100vh;background-color: rgb(176,192,194);">
    ...
    <div><a href="{{route('admin.index')}}"><h3>Back</h3></a></div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$ds['date']}}</td>
                            ...
                            <td><a href="{{route('admin.updateRequest', $ds['cid'])}}">Accept</a>|<a href="{{route('admin.deleteRequest', $ds['cid'])}}">Delete</a></td>
