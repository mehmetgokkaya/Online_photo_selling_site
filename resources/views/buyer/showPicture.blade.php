            ...
            <table class="table table-bordered table-hover">
                <thead class="bill-header cs">
                    <tr>
                        ...
                        <th id="trs-hd" class="col-lg-2">Price</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="/assets/Tempuploads/{{$ds->photo}}" width='500' height='400'></td>
                        ...
                        <td>{{$ds['price']}}</td>
                            ...
                            <td><a href="{{route('buyer.confirmbuy', $ds['pid'])}}">Buy</a>|<a href="{{route('buyer.comment', $ds['uid'])}}">Comment</a></td>
