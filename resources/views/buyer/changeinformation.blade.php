                ...
                <div class="form-group">
                    <div id="formdiv">
                        ...
                        <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            ...
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="text" name="email" value="{{$user['email']}}" maxlength="50" minlength="12" disabled="" style="margin-left:0px;font-family:Roboto, sans-serif;"></div>
                        </div>
                        <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                                <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:24px;"><strong>Phone</strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="text" name="phone" value="{{$user['phone']}}" maxlength="20"  style="margin-left:0px;font-family:Roboto, sans-serif;"></div>
                        </div>
                        
                        <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-12 col-md-4 offset-md-4"><a href="{{ URL::previous() }}" style="color: #cc0000" >BACK</a><button class="btn btn-light btn-lg" type="submit" style="margin-left:16px;">Update</button></div>
                        </div>
                    </div>
                </div>
            </form>
