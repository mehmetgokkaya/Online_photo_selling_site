            ...
            <form method="post">
                ...
                <div class="form-group">
                    <div id="formdiv">
                        ...
                        <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-12 col-md-4 offset-md-4"><a href="{{route('seller.uploadedphoto')}}" style="color: #cc0000" >BACK</a><button class="btn btn-light btn-lg" type="submit" style="margin-left:16px;">Update</button></div>
                        </div>
                    </div>
                </div>
            </form>
