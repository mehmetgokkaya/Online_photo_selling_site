...
<body style="width: 100%;height: 100vh;background-color: rgb(176,192,194);">
    ...
    <div class="col-md-12 search-table-col">
        ...
        <div class="table-responsive table-bordered table table-hover table-bordered results">
            <div class="col-12 col-md-4 offset-md-4"><a href="{{route('seller.index')}}" style="color: #cc0000" >BACK</a></div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$ds['uid']}}</td>
                            ...
                            <td><a href="{{route('seller.photoEdit', $ds['pid'])}}">Edit</a>|<a href="{{route('seller.photoDelete', $ds['pid'])}}">Delete</a></td>
